...
{
	[Serializable]
	internal struct LinkedIndexList
	{
		public int head;
		public int size;
	}
	...
	[Serializable]
	internal struct LinkedIndexItem
	{
		public int next;
		public int prev;
		public int data;
	...
	[Serializable]
	internal struct LinkedIndexEnumerable : IEnumerable<int>
	{
	...
	[Serializable]
	internal struct LinkedIndexEnumerator : IEnumerator<int>
	{
		public LinkedIndexItem[] items;
		public int headIndex;
