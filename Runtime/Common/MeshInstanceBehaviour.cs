...
namespace Tuanjie.NeuralDeformer
{
	...
	public abstract class MeshInstanceBehaviour : MonoBehaviour
	{
		...
		internal protected virtual void OnMeshInstanceCreated() { }
		internal protected virtual void OnMeshInstanceDeleted() { }
		...
		internal protected void EnsureMeshInstance()
		{
		...
		internal protected void RemoveMeshInstance()
		{
			if(TryGetComponent<SkinnedMeshRenderer>(out var smr))
			{
				if (smr.sharedMesh == null || IsMeshInstance(smr.sharedMesh))
